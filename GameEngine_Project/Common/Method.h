...
namespace Engine
{
    ...
    ///(January, 29, 2015)
    ///
    ///All Methods classes describe a method of a class. This is the similar design to Func but it's designed for Methods.


    ///Action Class Description:
    ///(January, 29, 2015)
    ///
    /// MethodAction classes are similar to Method however MethodAction return types are always void
