...
namespace Engine
{
    ...
    ///(January, 29, 2015)
    ///
    ///All Func classes are templates for functions. Simply define a Func using the proper return type and argument type signatures.
    ///The func class overrides the function operator and this the Func may be used as a function.
    ///Delegates inside the func define  the function definition of the attributes
    ///Note that Func may only be used with static / global functions and not member functions of the class.


    ///Action Class Description:
    ///(January, 29, 2015)
    ///
    /// Action classes are similar to Func however Action return types are always void
